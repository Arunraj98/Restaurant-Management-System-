<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/cutomer_feast_order.aspx.cs" Inherits="cutomer_bakentouch_order" %>
...
<ItemStyle Width="150px"></ItemStyle>
                        ...
                        <ItemTemplate>
                        <asp:Label ID="dasss" runat="server" Text='<%#Eval("status") %>' ></asp:Label>                                
                </ItemTemplate>
