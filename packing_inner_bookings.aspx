<%@ Page Language="C#" AutoEventWireup="true" CodeFile="packing_inner_bookings.aspx.cs" Inherits="packing_inner_bookings" %>
...
<body >
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Menu placed" Forecolor="#005000"  Font-Size="XX-Large" 
            CssClass="style2"  ></asp:Label>
              ...
              <div class="col-md-3 col-md-offset-3">
                  <asp:RadioButtonList ID="RadioButtonList1" runat="server">
                    <asp:ListItem Selected="True">Under packing</asp:ListItem>
                          <asp:ListItem>Packing finished</asp:ListItem>
                 ...
                 <asp:Button ID="btnsubmit" runat="server" Text="Update" class="form-control" Font-Bold="True" 
            BackColor="#005000"   
...
<ItemStyle Width="150px"></ItemStyle>
                        ...
                        <ItemTemplate>
                        <asp:Label ID="da" runat="server" Text='<%#Eval("quantity") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                                                       ...
                                                       <asp:TemplateField HeaderText="No of packs" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="das" runat="server" Text='<%#Eval("Nos") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                        ...
                        <ItemTemplate>
                        <asp:Label ID="das" runat="server" Text='<%#Eval("status") %>' ></asp:Label>                                
                </ItemTemplate>
