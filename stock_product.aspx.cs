...
public partial class staffproduct : System.Web.UI.Page
{
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        MySqlDataAdapter adapt = new MySqlDataAdapter("select pid,pname,photoname,price,stock,quantity from product where ptype='" + type + "'", con);
        con.Open();
        adapt.Fill(dt);
        con.Close();
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
      ...
      // string status = (row.FindControl("DropStatus") as DropDownList).Text;
       string stocks= (row.FindControl("TextBox1") as TextBox).Text;
        ...
        string query = "UPDATE product SET stock=@stock WHERE pid=@did";
