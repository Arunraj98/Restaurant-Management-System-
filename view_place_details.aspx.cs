...
public partial class view_zone_details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MySqlDataAdapter adapt = new MySqlDataAdapter("select zid,place from place", con);
        con.Open();
        adapt.Fill(dt);
        con.Close();
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string query = "UPDATE zone SET zone=@stock WHERE zid=@did";
