<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_place_details.aspx.cs" Inherits="view_zone_details" %>
...
<body>
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Places of delivery" Font-Size="XX-Large" 
    ...
    <asp:GridView ID="GridView2" runat="server"  
           ...
           EmptyDataText="No records has been added." CellSpacing="2" 
            ...
            onrowupdating="GridView1_RowUpdating" DataKeyNames="zid">

            <Columns>
            <asp:TemplateField HeaderText="Place code" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="pid" runat="server" Text='<%#Eval("zid") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                                ...
                                <asp:TemplateField HeaderText="Place" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="size" runat="server" Text='<%#Eval("place") %>' ></asp:Label>                                
                </ItemTemplate>
                 <EditItemTemplate>
