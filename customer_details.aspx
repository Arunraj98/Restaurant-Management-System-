<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer_details.aspx.cs" Inherits="approve_client" %>
...
<body>
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Our Customers" Forecolor="#005000" 
    ...
    <asp:GridView ID="GridView2" runat="server"  
            ...
            DataKeyNames="emailid"   PageSize = "3" AllowPaging ="True" 
           EmptyDataText="No records has been added."
             onrowcancelingedit="GridView2_RowCancelingEdit" 
             onrowediting="GridView2_RowEditing" 
            onrowupdating="GridView2_RowUpdating" Height="196px" CellSpacing="2" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Address" ItemStyle-Width="350">
                 ...
                 <asp:TemplateField HeaderText="Place" ItemStyle-Width="350">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Email" ItemStyle-Width="150">
                   ...
                   <asp:TemplateField HeaderText="Customer Status" ItemStyle-Width="150">
                    <ItemTemplate>
