<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update_resrvation.aspx.cs" Inherits="update_resrvation" %>
...
<body>
            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                     ...
                     <li><a href="Logout.aspx">Logout</a> </li>         </ul>
                     </li>
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Update Reservation Details" Font-Size="XX-Large" 
    ...
    <asp:GridView ID="GridView2" runat="server"  
           ...
           EmptyDataText="No records has been added." CellSpacing="2" 
            ...
            onrowupdating="GridView1_RowUpdating" DataKeyNames="rid">

            <Columns>
            <asp:TemplateField HeaderText="Sl no" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="pid" runat="server" Text='<%#Eval("rid") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                        ...
                        <ItemTemplate>
                        <asp:Label ID="size" runat="server" Text='<%#Eval("amount") %>' ></asp:Label>                                
                </ItemTemplate>
                 <EditItemTemplate>
