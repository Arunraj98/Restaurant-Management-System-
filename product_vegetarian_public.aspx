<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_vegetarian_public.aspx.cs" Inherits="product_bouquet_public" %>
                  ...
                  <div class="col-md-3">
                     <div class="p-card p-card2">
                        ...
                        <div class="product-txt">
                           ...
                           <p class="content-text txtal">Price: <%# Eval("price")%>
                       

                              </br> <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Buy">Buy Now</asp:LinkButton>
