...
public partial class packing_inner_bookings : System.Web.UI.Page
{
    ...
    protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
            ...
            else
            {
                ...
                using (MySqlConnection con = new MySqlConnection(ConString))
                {
                    using (MySqlCommand cmd = new MySqlCommand(query))
                    {
                        ...
                        Response.Write("<script>alert('Success!! Cancelled Your order')</script>");
        ...
        else
        {
            ...
            Response.Write("<script>alert('Sorry!! You can't cancel order as it is bought under offer')</script>");
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
       
        {
            ...
            if (bs == "Delivered")
            {
                ...
                Response.Write("<script>alert('Delivery status already updated')</script>");
            ...
            else
            {
                ...
                con22.Open();
                MySqlCommand cmd22 = new MySqlCommand("select username from login where role='Delivery staff'", con22);
                ...
                if (RadioButtonList1.SelectedItem.Text== "Delivered")
                {
                    ...
                    MySqlCommand cmdd = new MySqlCommand("update pay set bstatus='" + RadioButtonList1.SelectedItem.Text + "',status='paid', ddate='"+DateTime.Now+"' where pcode='" + Session["pid"].ToString() + "'", cond);
                    ...
                    MyMailMessage.Subject = "Hai, this is from Feast. Delivery status of your food order";
                    MyMailMessage1.Subject = "Delivery staus details";



                    MyMailMessage.Body = "Current status of your food order with order code " + pc + " is " + RadioButtonList1.SelectedItem.Text + " .There will be no refund for paid amount.";
                    MyMailMessage1.Body = "Delivery status updated for order from " + zone + " with order code "+pc+"  .Login and check for details";
                ...
                else
                {
                    ...
                    MySqlCommand cmdd = new MySqlCommand("update pay set bstatus='" + RadioButtonList1.SelectedItem.Text + "' where pcode='" + Session["pid"].ToString() + "'", cond);
                    ...
                    MyMailMessage.Subject = "Hai, this is from Feast. Currrent status of your order details";


                    MyMailMessage.Body = "Current status of your purchase with order code " + pc + " is" +RadioButtonList1.SelectedItem.Text + " .There will be no refund for paid amount.";
                ...
                Response.Write("<script>alert('Delivery status updated')</script>");
