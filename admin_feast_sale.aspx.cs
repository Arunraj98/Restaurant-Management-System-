...
public partial class admin_zone_sale : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        DataTable dt = new DataTable();
        MySqlConnection con = new MySqlConnection(ConString);
        MySqlDataAdapter adapt = new MySqlDataAdapter("SELECT payid,name,email,address,phone,place,status,amount,mode from pay where place='"+DropDownList2.SelectedItem.Text+"'", con);
        con.Open();
        adapt.Fill(dt);
        con.Close();
    ...
    protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        Response.Redirect("~/admin_food_sales.aspx");
