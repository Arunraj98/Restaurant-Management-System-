<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_resrvationstatus.aspx.cs" Inherits="CustomerDesigncost" %>
...
<body>
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Your Reservation details" Forecolor="#005000"  Font-Size="XX-Large" 
        ...
        <br />
          ...
          <strong>
        <asp:Label ID="Label2" runat="server" Text="You can cancel or confirm your reservation here.!" Forecolor=" #B3001E"  Font-Size="X-Large" 
            CssClass="style2"  ></asp:Label>
        </strong>
