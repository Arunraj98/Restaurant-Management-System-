...
public partial class product_cake_out : System.Web.UI.Page
{
    ...
    {
        string query = "select pid,photoname,pname,price,stock,quantity from product where ptype='Non Vegetarian'";
