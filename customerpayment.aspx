...
<body  background="images/back.jpeg">
                    ...
                    <li><a href="customer__main_home.aspx">Home</a> </li>
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li><a href="cutomer_fashionzone_order.aspx">Yours order</a></li>
                            </ul>
                     </li>
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Customized design<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                           <li class="dropdown">
                            <li><a href="design.aspx">Submit</a></li> 
                           <li><a href="designstatus.aspx">Status</a></li>
                           <li><a href="Cancelorder.aspx">cancel</a></li>
                           <li><a href="Customerdesigncost.aspx">Cost</a></li>
                           <li><a href="customerpayment.aspx">Payment</a></li>
                            </ul>
                     </li>
                     sss
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Payment" Forecolor="#ffffff"  Font-Size="XX-Large" 
            CssClass="style2"  ></asp:Label>
        </strong>
        </br></br>
    <asp:GridView ID="GridView2" runat="server"  
             BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" Width="1200px" 
...
<ItemStyle Width="150px"></ItemStyle>
                                                 ...
                                                 <asp:TemplateField HeaderText="Date for delivery" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="fdate" runat="server" Text='<%#Eval("functiondate") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                             ...
                             <asp:CommandField ButtonType="Button" ShowEditButton="true"  EditText="Choose Mode" UpdateText="Go" CancelText="Back" ControlStyle-BackColor="#6d646c" ControlStyle-CssClass="btn " ControlStyle-Width="100" ControlStyle-ForeColor="#ffffff" ControlStyle-Height="35"
                    ItemStyle-Width="150" >
            ...
            <HeaderStyle BackColor="#6d646c" Font-Bold="True" ForeColor="White" Font-Size="16px"/>
