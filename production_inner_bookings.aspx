<%@ Page Language="C#" AutoEventWireup="true" CodeFile="production_inner_bookings.aspx.cs" Inherits="packing_inner_bookings" %>
    ...
    <div align="center">
        ...
        <asp:Label ID="Label1" runat="server" Text="Menu placed" Forecolor="#005000"  Font-Size="XX-Large" 
            CssClass="style2"  ></asp:Label>
                 ...
                 <asp:Button ID="btnsubmit" runat="server" Text="Preparation completed" class="form-control" Font-Bold="True" 
            BackColor="#005000"   
