<%@ Page Language="C#" AutoEventWireup="true" CodeFile="advancepayment.aspx.cs" Inherits="advancepayment" %>
         ...
         <tr>
          ...
          <td>
           <asp:TextBox ID="firstname" runat="server"  class="form-control"  ForeColor="#800000" 
            Width="200px" Height="35px" placeholder="Enter first name"/></td></br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Amount</td>
          ...
          <asp:TextBox ID="amount" runat="server" class="form-control"  ForeColor="#800000" 
            Width="200px" Height="35px" TextMode="Number" /></td>
            </tr>
            </br>
            <tr>
                <td class="style5"></br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Email Id</td>
            ...
            Width="200px" Height="35px" placeholder="Enter emailid" /></td>
            </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Phone</td>
           ...
           <asp:TextBox ID="phone" runat="server"  class="form-control"  ForeColor="#800000" 
            Width="200px" Height="35px" placeholder="Enter phone no" TextMode="Number"/></td>
            </tr>
          </br>
