...
public partial class staff_Customerregistration : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (j > 0)
        {
            MySqlCommand cmd1 = new MySqlCommand("insert into login (username,password,role,status)values('" + txtemailid.Text + "','" + otp + "','customer','Approved')", con);
            ...
            if (i > 0)
            {
                ...
                MyMailMessage.Subject = "Hi"+txtname.Text+" This is from Feast.Your account details";

                MyMailMessage.Body = "Your username:"+txtemailid.Text+" and Password: "+otp+". Now You can login and place order and we will deliver your food items" ;
