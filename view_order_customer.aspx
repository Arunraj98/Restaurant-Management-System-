<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_order_customer.aspx.cs" Inherits="view_order_customer" %>
...
<body >
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Your orders" Forecolor="#005000"  Font-Size="XX-Large" 
...
<ItemStyle Width="150px"></ItemStyle>
                          ...
                          <asp:TemplateField HeaderText="Order status" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="at" runat="server" Text='<%#Eval("bstatus") %>' ></asp:Label>                                
                </ItemTemplate>
