...
public partial class Responsehandlingso : System.Web.UI.Page
{
            ...
            if (Request.Form["status"] == "success")
            {

                {
                    ...
                    if (dr1.Read())
                    {
                        ...
                        string query11 = "insert into pay(amount,pcode,date,ddate,name,address,place,phone,zone,status,mode,email) values('" + Request.Form["amount"] + "','" + otp + "','" + DateTime.Now + "','Not delivered','" + Request.Form["firstname"].ToString() + "','" + dr1[1].ToString() + "','" + dr1[8].ToString() + "','" + dr1[3].ToString() + "','" + dr1[9].ToString() + "','Paid','Online','" + Request.Form["email"].ToString() + "')";
                                    ...
                                    using (MySqlConnection con = new MySqlConnection(ConString))
                                    {
                                        using (MySqlCommand cmd = new MySqlCommand(query))
                                        {
                                            ...
                                            if (k > 0)
                                            {
                                                ...
                                                string query1 = "UPDATE productoffer SET stock=@stock WHERE pid=@did";
