...
public partial class update_resrvation : System.Web.UI.Page
{
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        MySqlDataAdapter adapt = new MySqlDataAdapter("select rid,amount from reserve where no_of_seats='" + type + "'", con);
        con.Open();
        adapt.Fill(dt);
        con.Close();
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string query = "UPDATE reserve SET amount=@stock WHERE rid=@did";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string query = "DELETE FROM subcat WHERE scid=@Bno";
