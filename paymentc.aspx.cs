...
public partial class paymentc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Random r = new Random();
        otp = r.Next().ToString().Substring(0, 4);
        ...
        if (dr2.Read())
        {
            ...
            zone = dr2[3].ToString();
            productinfo.Text = Session["nitems"]+" items";
            ...
            amount.Text =(Convert.ToInt16(Session["amt"].ToString())+40).ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            if (RadioButtonList1.SelectedItem.Text == "Cash on delivery")
            {
                    ...
                    string query11 = "insert into pay(amount,pcode,date,ddate,name,address,place,phone,zone,status,mode,email,bstatus) values('" + amount.Text + "','" + otp + "','" + DateTime.Now + "','Not delivered','" + firstname.Text + "','" + address1.Text + "','" + TextBox1.Text + "','" + phone.Text + "','" + zone + "','Not paid','Cash on delivery','" + Session["user"].ToString() + "','Booked')";
                    ...
                    using (MySqlConnection con11 = new MySqlConnection(ConString))
                    {
                        using (MySqlCommand cmd11 = new MySqlCommand(query11))
                        {
                            ...
                            if (l > 0)
                            {
                                string query = "update sales set pcode='"+otp+"',mode='Cash on delivery',status='Not paid',buystatus='Buy' where buystatus='Cart' and email='"+Session["user"].ToString()+"'";
                                ...
                                using (MySqlConnection con = new MySqlConnection(ConString))
                                {
                                    using (MySqlCommand cmd = new MySqlCommand(query))
                                    {
                                        ...
                                        if (k > 0)
                                        {
                                            ...
                                            string query2 = "UPDATE sales SET buystatus=@stock WHERE pcode=@did";
                                            ...
                                            using (MySqlConnection con1 = new MySqlConnection(ConString))
                                            {
                                                using (MySqlCommand cmd1 = new MySqlCommand(query2))
                                                {
                                                    ...
                                                    cmd1.Parameters.AddWithValue("@did", otp);
                                                    ...
                                                    if (k > 0)
                                                    {
                                                        ...
                                                        MyMailMessage.Body = "Order code :" + otp + "\namount :" + amount.Text + "\n Payment mode :" + RadioButtonList1.SelectedItem.Text + "....We will deliver your food items soon and for details login and check. Total amount includes delvery charge for your order";
                                                        ...
                                                        MyMailMessage1.Body = "New order for production  from " + zone + " .Login and check for details";
            ...
            else
            {
                ...
                string query3 = "select pname,price,ptype,stock,photoname,quantity from product";
                ...
                if (dr1.Read())
                {
                    ...
                    int st = Convert.ToInt16(dr1[3].ToString()) - 1;
                    ...
                    MySqlCommand cmd31 = new MySqlCommand("insert into addresscart(address,email,phone,zone,place) values('" + address1.Text + "','" + Session["user"].ToString() + "','" + phone.Text + "','" + zone + "','" + TextBox1.Text + "')", con31);
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(hash1))
                    {
                        ...
                        data.Add("surl", "http://localhost:57512/feast/ResponseHandling.aspx");
