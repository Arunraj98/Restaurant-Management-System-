<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_subtype.aspx.cs" Inherits="add_subtype" %>
  ...
  <body>
    ...
    <div class="cus-style">
      ...
      <div class="col-md-5 col-md-offset-7">
       <strong>
       <asp:Label ID="Label6" runat="server" Text="Add Food type" Font-Size="XX-Large" 
              ...
              <div class="col-md-3 col-md-offset-5">
               <asp:Label ID="Label5" runat="server" Text="Food type"   Font-Bold="True" ForeColor="#005000"></asp:Label></div>
                 <div class="col-md-3 col-md-offset-1"><asp:DropDownList ID="DropDownList1" runat="server" class="form-control" 
                   ...
                   <div class="row">
              <div class="col-md-3 col-md-offset-5">
               <asp:Label ID="Label8" runat="server" Text="Sub type"   Font-Bold="True" ForeColor="#005000"></asp:Label></div>
                 <div class="col-md-3 col-md-offset-1"> <asp:TextBox ID="TextBox2" runat="server" class="form-control"  ForeColor="#800000" 
            Width="200px" Height="35px" placeholder="Enter food sub type"  required="required"></asp:TextBox>
