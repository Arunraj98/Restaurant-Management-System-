<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paymentsuccessa.aspx.cs" Inherits="paymentsuccessa" %>
...
<body>
   ...
   <span class="style4">
       ...
       <strong>
       <asp:Label ID="Label6" runat="server" Text="Reservation charge payment success.</br>Your reservation confirmed.</br>Thank You..!!!" Font-Size="XX-Large" CssClass="lcolor"
