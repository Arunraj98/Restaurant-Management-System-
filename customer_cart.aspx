<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer_cart.aspx.cs" Inherits="customer_cart" %>
...
<body >
    ...
    <div align="center">
        <strong>
        <asp:Label ID="Label1" runat="server" Text="Your Cart" Forecolor="#005000"  Font-Size="XX-Large" 
       ...
       <asp:TextBox ID="TextBox1" runat="server" Width="200px"  class="form-control"  Height="35px" placeholder="Search" Visible="false"></asp:TextBox>
       <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Place order" class="form-control" Font-Bold="True" 
            BackColor="#005000"   
            ForeColor="White" Height="37px" Width="200px" Visible="false" />
    ...
    <asp:GridView ID="GridView2" runat="server"  
           ...
           EmptyDataText="No records has been added." CellSpacing="2" 
            ...
            DataKeyNames="paymentid" onrowcancelingedit="GridView2_RowCancelingEdit" 
            onrowediting="GridView2_RowEditing"
            onrowupdating="GridView2_RowUpdating" ForeColor="Black">
            <Columns>
                

                <asp:TemplateField HeaderText="Booking code" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                            <asp:Label ID="pid" runat="server" Text='<%#Eval("paymentid") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                                ...
                                <asp:TemplateField HeaderText="Product" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("photoname") %>' Height="150px" Width="150px"/>
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                                ...
                                <asp:TemplateField HeaderText="No of plates" ItemStyle-Width="150">
                    
                        <ItemTemplate>
                        <asp:Label ID="qt" runat="server" Text='<%#Eval("quantity") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                        ...
                        <ItemTemplate>
                        <asp:Label ID="ns" runat="server" Text='<%#Eval("nos") %>' ></asp:Label>                                
                </ItemTemplate>
...
<ItemStyle Width="150px"></ItemStyle>
                ...
                <asp:CommandField ButtonType="Button" ShowEditButton="true" ControlStyle-BackColor="#000000" ControlStyle-ForeColor="#ffffff" ControlStyle-CssClass="btn" ControlStyle-Width="80" ControlStyle-Height="35" EditText="Remove" UpdateText="Confirm" CancelText="Back"
                    ItemStyle-Width="150" >


<ControlStyle BackColor="#005000" CssClass="btn" ForeColor="White" Height="35px" Width="80px"></ControlStyle>
