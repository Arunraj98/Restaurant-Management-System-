...
public partial class ordermanager_reservation_details : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        else
        {
            ...
            string query = "UPDATE reservation SET payid=did WHERE payid=@did";
            ...
            using (MySqlConnection con = new MySqlConnection(ConString))
            {
                using (MySqlCommand cmd = new MySqlCommand(query))
                {
                    ...
                    MySqlConnection con231 = new MySqlConnection(ConString);
                    con231.Open();
                    MySqlCommand cmd231 = new MySqlCommand("select username from login where role='Order management manager'", con231);

                    string statt = cmd231.ExecuteScalar().ToString();
                    ...
                    MyMailMessage.To.Add(statt);

                    MyMailMessage.Subject = "Status for food under reservation updated";

                    MyMailMessage.Body = "Food ready for Reservation with code" + did + ", submitted for date " + date;
                    ...
                    try
                    {
                        ...
                        Response.Write("<script>alert('success!! Status of food under reservation updated ')</script>");
