...
public partial class om_manager_inner_home : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string query = "select pid,photoname,pname,price,stock,quantity from product where  ptype like '%" + TextBox1.Text + "' or quantity like '%" + TextBox1.Text + "' or pname like '%" + TextBox1.Text + "' or ptype like '" + TextBox1.Text + "%' or quantity like '" + TextBox1.Text + "%' or pname like '" + TextBox1.Text + "%'";
